...
<style>
    .error-section {
        ...
        background:
            ...
            radial-gradient(circle at 85% 15%, rgba(34,197,94,.28), transparent 32%),
            radial-gradient(circle at 70% 90%, rgba(21,128,61,.30), transparent 36%),
    ...
    .error-icon {
        ...
        color: #fff;
        box-shadow: 0 16px 34px rgba(30,82,16,.28);
    }
    ...
    <div class="error-card">
        <div class="error-icon">
            <svg width="42" height="42" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z" stroke="currentColor" stroke-width="2.1" stroke-linejoin="round"/>
            </svg>
        </div>
        ...
        <p class="error-text">
            Sistem mendeteksi terlalu banyak aktivitas dalam waktu singkat.
            Silakan tunggu sebentar sebelum mencoba login kembali.
        </p>
        ...
        <div class="error-note">
            Tips keamanan: jangan klik tombol login berulang kali terlalu cepat.
            Tunggu beberapa saat agar akses dibuka kembali.
        </div>
    </div>
</section>
@endsection