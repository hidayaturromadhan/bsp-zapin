            ...
            <div class="login-body">
                ...
                <form method="POST" action="{{ route('password.reset.update') }}" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help">
                            Gunakan minimal 8 karakter agar password lebih aman.
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrap">
                            ...
                            <button type="button" class="password-toggle" data-target="password_confirmation" aria-label="Tampilkan password">
                                <svg class="eye" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                                    <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/>
                                    <circle cx="12" cy="12" r="3"/>
                                </svg>
