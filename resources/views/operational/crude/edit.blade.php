...
<div class="op-page-head">
    <div>
        ...
        <h1 class="op-page-title">Edit Data Produksi Crude</h1>
        <p class="op-page-desc">
            Perbarui data produksi crude harian berdasarkan Vacuum Truck dan Road Tank.
        </p>
    </div>
</div>
...
<div class="op-card">
    <div class="op-card-head">
        <div>
            <h2 class="op-card-title">Form Edit Crude</h2>
            <div class="op-card-desc">
                Sesuaikan data Vacuum Truck dan Road Tank bila ada revisi lapangan.
            </div>
        </div>
    </div>

    <div class="op-card-body">
        <form method="POST" action="{{ route('operational.crude.update', $record->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="op-form-grid">
                ...
                <div class="op-field">
                    ...
                    <input
                        ...
                        name="vacuum_truck"
                        class="op-input"
                        value="{{ old('vacuum_truck', $record->vacuum_truck) }}"
                ...
                <div class="op-field">
                    ...
                    <input
                        ...
                        name="road_tank"
                        class="op-input"
                        value="{{ old('road_tank', $record->road_tank) }}"
