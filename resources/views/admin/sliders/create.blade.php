...
<div class="admin-form-wrap">
    <div class="admin-form-shell">
        <div class="admin-page-head">
            <h1 class="admin-page-title">Tambah Slider</h1>
            <p class="admin-page-subtitle">
                Tambahkan slider baru untuk halaman utama. Isi judul, tautan, urutan, dan unggah gambar terbaik.
            </p>
        </div>
        ...
        <div class="admin-card">
            <form method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data">
                ...
                <div class="admin-form-grid">
                    ...
                    <div class="admin-field">
                        <label class="admin-label" for="image">Gambar (jpg/png/webp, max 2MB) *</label>
                        <input
                            id="image"
                            type="file"
                            name="image"
                        ...
                        >
                        <div class="admin-help">
                            Gunakan gambar dengan komposisi lebar agar hasil slider lebih optimal.
                        </div>
                    </div>

                    <div class="admin-form-actions">
                        <button type="submit" class="admin-btn-primary">Simpan</button>
                        <a href="{{ route('admin.sliders.index') }}" class="admin-btn-secondary">Batal</a>
                    </div>
                </div>
            </form>
        </div>
