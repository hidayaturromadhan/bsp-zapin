...
@section('title', 'Tambah Highlight GCG')
...
<div class="a-page-head">
    <div class="a-page-head-copy">
        ...
        <h1 class="a-page-title">Tambah Highlight GCG</h1>
        <p class="a-page-desc">Isi label dalam Bahasa Indonesia. Versi English akan diterjemahkan otomatis.</p>
    </div>
...
<form action="{{ route('admin.gcg-highlight-items.store') }}" method="POST">
    @csrf
    ...
    <div class="a-card">
        <div class="a-card-head">
            <div>
                ...
                <div class="a-card-desc">Sistem akan otomatis menyimpan versi English untuk tampilan locale EN.</div>
            </div>
        </div>
